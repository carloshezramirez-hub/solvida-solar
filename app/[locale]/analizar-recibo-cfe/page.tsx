...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Analiza tu Recibo de CFE | Evaluación Solar Gratuita — SOLVIDA",
    description:
      "Comparte tu recibo de CFE y te preparamos una evaluación solar inicial sin compromiso en San Miguel de Allende.",
    alternates: { canonical: `${baseUrl}/es/analizar-recibo-cfe` },
  };
}

export default async function AnalizarReciboCFE({ params }: Props) {
